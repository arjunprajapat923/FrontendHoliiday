        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {users.map((user) => (
            <div key={user._id} className="bg-white p-4 rounded-lg shadow">
              ...
              {user.qrCode && (
                <img src={user.qrCode} alt="QR Code" className="mt-2" />
              )}
            </div>
          ))}
        </div>
